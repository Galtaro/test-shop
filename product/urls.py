...
urlpatterns = [
    ...
    path('items/<int:pk>/update_destroy_item/', UpdateDestroyApiItem.as_view(),
    ...
    path('bucket/items/<int:pk>/update_destroy_bucket_item/', UpdateDestroyApiBucketItem.as_view(),
         name="update-destroy-bucket-item"),
    path('bucket/add_promocode/', UpdateApiBucketPromocodeTotalPrice.as_view(),
         name="update-bucket-promocode-total-price"),
    ...
    path('promocode/<int:pk>/update_destroy_promocode/',
         UpdateDestroyApiPromocode.as_view(),
